...
//    private MyAdapter adapt;
    ...
    private EditText editPetHistory;

    private TextView myTaskImagePath;
...
//        editPetName = (EditText) findViewById(R.id.editText3);
//        editPetBreed = (EditText) findViewById(R.id.editText10);
//        editPetAge = (EditText) findViewById(R.id.editText9);
//        editPetWeight = (EditText) findViewById(R.id.editText11);
//        editPetOwner = (EditText) findViewById(R.id.editText);
//        editPetContact = (EditText) findViewById(R.id.editTextContact);
//        editPetHistory = (EditText) findViewById(R.id.editText12);
//        myTaskImagePath = (TextView) findViewById(R.id.imagePath);
...
//    }
    ...
    private void saveImage(Bitmap finalBitmap, String image_name) {
        ...
        try {
            ...
            out.flush();
            out.close();
            myTaskImagePath.setText(root+fname);
        } catch (Exception e) {
            e.printStackTrace();
            myTaskImagePath.setText("Error saving image");
        }
    }
